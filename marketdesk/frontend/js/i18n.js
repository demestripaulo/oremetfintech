...
const I18N = {
  en: {
    ...
    kxCalibRecal: 'Recalibrated Brier', kxCalibRecalSkill: 'Recalibrated skill',
    kxCalibRecalNote: 'in-sample, illustrative only', kxBucketsTitle: 'Model reliability by confidence bucket',
  ...
  pt: {
    ...
    kxCalibRecal: 'Brier recalibrado', kxCalibRecalSkill: 'Skill recalibrado',
    kxCalibRecalNote: 'in-sample, apenas ilustrativo', kxBucketsTitle: 'Confiabilidade do modelo por faixa de confiança',
